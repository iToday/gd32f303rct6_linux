...
void lv_port_disp_init(void)
{
    ...
    static lv_color_t buf_1[MY_DISP_HOR_RES * 10];                          /* 设置缓冲区的大小为屏幕的全尺寸大小 */
...
//    static lv_color_t buf_2_1[MY_DISP_HOR_RES * 10];                        /* 设置另一个缓冲区的大小为 10 行屏幕的大小 */
//    lv_disp_draw_buf_init(&draw_buf_dsc_2, buf_2_1, buf_2_1, MY_DISP_HOR_RES * 10);   /* 初始化显示缓冲区 */

//    /* 全尺寸双缓冲区示例) 并且在下面设置 disp_drv.full_refresh = 1 */
//    static lv_disp_draw_buf_t draw_buf_dsc_3;
//    static lv_color_t buf_3_1[MY_DISP_HOR_RES * MY_DISP_VER_RES];            /* 设置一个全尺寸的缓冲区 */
//    static lv_color_t buf_3_1[MY_DISP_HOR_RES * MY_DISP_VER_RES];            /* 设置另一个全尺寸的缓冲区 */
//    lv_disp_draw_buf_init(&draw_buf_dsc_3, buf_3_1, buf_3_2, MY_DISP_VER_RES * LV_VER_RES_MAX);   /* 初始化显示缓冲区 */
